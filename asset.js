    ...
    [document.getElementById('price'), document.getElementById('capital-2'), document.getElementById('capital')
        , document.getElementById('amrt'), document.getElementById('aprct'), document.getElementById('duration')].forEach(function (element) {
            ...
            element.addEventListener('change', function () {
                ...
                // console.log(oe , w , duration , ue , kauf , equity+"mend part 2!!!!!!!!!!");
                ...
                document.getElementById("asct").textContent = f(Number(g(out)) - Math.round(oe)) + " €";
...
function slides() {
    ...
    let l = window.matchMedia("(min-width:960px)");
...
function C_res(hh) {
    ...
    Ne = parseInt(Ne);
    document.getElementById("slide2-cont").textContent = f(Math.round((Math.round(Ne - (parseInt(g(P)) + parseInt(g(W)) + parseInt(g(A)) + parseInt(g(K)))) /
        (12 * parseInt(g(time))))));
    ...
    document.getElementById("return").textContent = f(ans) + " %";
    //    return
...
[document.getElementById("price"), document.getElementById("duration"), document.getElementById("rg1")].forEach(function (element) {
    ...
    element.addEventListener('change', function () {
        ...
        document.getElementById("slide2-cont").textContent = Math.round(Math.round(Ne - (parseInt(g(P)) + parseInt(g(W)) + parseInt(g(A)) + parseInt(g(K)))) /
            (12 * parseInt(g(time)))).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
        ...
        document.getElementById("return").textContent = (ans).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") + " %";
