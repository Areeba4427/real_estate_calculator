    ...
    [document.getElementById('sp1'), document.getElementById('sp2'), document.getElementById('sp3')].forEach(function (element) {
        element.addEventListener("change", function () {
            ...
            if (this.id == "sp1") {
                ...
                if ($("#upper-part").find("label#additional-cost").length !== 0) {

                    $("#upper-part").find("#additional-cost").remove();
                    $("#upper-part").find("#additional-cost-price").remove();
                    $("#upper-part").find("#sign1").remove();
                }

                let d1 = document.createElement("label");
                d1.setAttribute("id", "additional-cost");
                d1.textContent = "+Kaufnebenkosten:";
            ...
            if (this.id == "sp2") {
                ...
                var pt = document.querySelector("#upper-part");
                if ($("#upper-part").find("label#broker-cost").length !== 0) {

                    $("#upper-part").find("#broker-cost").remove();
                    $("#upper-part").find("#broker-cost-price").remove();
                    $("#upper-part").find("#sign2").remove();
                }


                let d1 = document.createElement("label");
                d1.setAttribute("id", "broker-cost");
                d1.textContent = "+Marklergebühr:";
                d1.setAttribute("class", "txtr");
            ...
            if (this.id == "sp3") {
                ...
                var pt = document.querySelector("#upper-part");
                if ($("#upper-part").find("label#misc-cost").length !== 0) {
                    // it has already been created.

                    $("#upper-part").find("#misc-cost").remove();
                    $("#upper-part").find("#misc-cost-price").remove();
                    $("#upper-part").find("#sign3").remove();
                }


                let d1 = document.createElement("label");
                d1.setAttribute("id", "misc-cost");
                d1.textContent = "+Sonstiges:";
                d1.setAttribute("class", "txtr");
...
[document.getElementById('r-v'), document.getElementById('rent'), document.getElementById('duration')].forEach(function (element) {
    element.addEventListener("change", function () {
        ...
        ue = parseInt(ce) + parseInt(me);
        he = ue + parseInt(g(f)) + parseInt(g(k));

        ve = he - ee;

        console.log(ve, he, ue, ee, ce, me);

        if (this.id == 'duration' || this.id == 'rent' || this.id=='r-v') {
        ...
        if (this.id == 'r-v' || this.id == 'duration' || this.id == 'rent') {
            if (this.id == 'rent') {
                if (latch == false) {
                    latch = true;
                    return;
        ...
        // document.getElementById('b1').textContent  =   (parseInt(ve +
        // parseInt(g(V)) -
        // parseInt(g(V)) * Math.pow(1 + 0.01 * parseInt((I)),  1))).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

        // document.getElementById('b2').textContent  =   parseInt(ve +
        //     parseInt(g(V)) -
        //     parseInt(g(V)) * Math.pow(1 + 0.01 * parseInt((I)),  2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

        //     document.getElementById('b3').textContent  =   parseInt(ve +
        //         parseInt(g(V)) -
        //         parseInt(g(V)) * Math.pow(1 + 0.01 * parseInt((I)),  3)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
    ...
    [document.getElementById('price'), document.getElementById('capital-2'), document.getElementById('capital')].forEach(function (element) {
        ...
        element.addEventListener('change', function () {
            ...
            if (this.id == "capital-2" || this.id == "capital") {
                ...
                if ($("#upper-part").find("label#equity-cost").length !== 0) {
                    // it has already been created.
                    // console.log('dfjs');
                    $("#upper-part").find("#equity-cost").remove();
                    $("#upper-part").find("#equity-cost-price").remove();
                    $("#upper-part").find("#sign4").remove();
                }
...
function C_res(hh) {
    ...
    Ne = parseInt(g(P)) + parseInt(g(W)) + parseInt(g(A)) + parseInt(g(K)) + 12 * (((hh) - parseInt(g(z))) * parseInt(g(time))) - be;
    ...
    //percentage 
    let pe = document.getElementById("out-profit").textContent;

    // console.log(pe , Ne);
    let ans = Math.abs(Math.round(100 * (g(pe) / g(Ne) - 1)))
