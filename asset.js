...
function eprofit() {
    ...
    console.log(ue, g(kauf), g(equity))
    let oe = g(kauf) - g(equity);
    for (let r = 0; r < 12 * Number(duration); ++r) {
        oe -= ue - oe * ((0.01 * w) / 12);
    }
        ...
        , document.getElementById('amrt'), document.getElementById('aprct'), document.getElementById('duration')].forEach(function (element) {
            ...
            element.addEventListener('change', function () {
                ...
                let w = 2;
                    ...
                    document.getElementById("out-profit").textContent = f(g(out) - Math.round(oe));
                    document.getElementById("asct").textContent = f(g(out) - Math.round(oe)) + " €";
                    document.getElementById("profits-2").textContent = f(g(out) - Math.round(oe)) + " €";
